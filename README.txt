...
[1]: https://github.com/harikrut/featured-image-with-url/
...
== 1.1.4 - 2026-06-15 ==
* **Feature:** Download images in random order instead of sequential post ID order for better initial coverage.

== 1.1.3 - 2026-06-15 ==
* **Added:** Display a table of the 10 most recent successful downloads in settings page.
...
* **Added:** Settings-page download progress stats.
